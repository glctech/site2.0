...
import * as newsletterCronTest from './functions/api/newsletter/cron-test.js';
import { runWeeklyCron } from './functions/api/_lib/newsletter/pipeline.mjs';
...
const routes = {
  ...
  '/api/newsletter/cron-test': newsletterCronTest,
};
...
export default {
  ...
  async scheduled(event, env, ctx) {
    ctx.waitUntil(runWeeklyCron(env).catch((err) => console.error('newsletter cron failed:', err)));
  },
};
